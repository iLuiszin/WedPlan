...
function BudgetItemComponent({ budget }: BudgetItemProps) {
  ...
  const handleUpdateCategory = useCallback(async (updated: ICategory) => {
    setCategory(updated);
  ...
  }, [budget._id, showConfirm, deleteBudget]);
